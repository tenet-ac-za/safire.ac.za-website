...
Below is a list[^autogenerated] of participants in SAFIRE who currently act as service providers and provide services to others. You can click on a participant to find out more[^extra].
...
[^autogenerated]: This list is automatically generated from SAML metadata was last refreshed at {{< participantlistlastmod >}}.
[^extra]: Some extra detail for providers is hidden by default and can be [shown if desired](?extra=1)
