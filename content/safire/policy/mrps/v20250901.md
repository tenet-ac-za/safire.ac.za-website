...
The most recent version of document SHALL be published on the Federation website at [https://safire.ac.za/safire/policy/mrps/]({{< ref "/safire/policy/mrps/_index.md" >}}). Updates to the document SHALL be accurately reflected in entity metadata.
