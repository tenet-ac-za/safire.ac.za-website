...
| ~urn:mace:safire.ac.za:entitlement:certs:smime~ | Used by the [SA NREN Certificate Service](https://www.tenet.ac.za/services/certs/) to authorise issuing client (S/MIME) certs. Discontinued 2026/08/01. |
| ~urn:mace:safire.ac.za:entitlement:certs:ssl~ | Can be used by the [SA NREN Certificate Service](https://www.tenet.ac.za/services/certs/) to authorise issuing SSL certs for web servers. Discontinued 2026/08/01. |
...
| urn:mace:safire.ac.za:entitlement:eduroam:admin | Used by [eduroam.ac.za](https://www.tenet.ac.za/services/eduroam) management portal & supporting services |
