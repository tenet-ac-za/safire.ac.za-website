...
attributeFormat: |2
  ...
  An _eduPersonEntitlement_ of "`urn:mace:dir:entitlement:common-lib-terms`" will be generated by SAFIRE if _eduPersonEntitlement_ is NOT supplied by the identity provider AND ( either [_eduPersonAffiliation_](/technical/attributes/edupersonaffiliation/) contains "`member`" OR [_eduPersonAffiliation_](/technical/attributes/edupersonaffiliation/) contains "`member@scope`" ).
