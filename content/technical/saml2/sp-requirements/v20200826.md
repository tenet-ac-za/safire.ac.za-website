...
Note: SAFIRE curates metadata to ensure both technical correctness and compliance with administrative controls. Changes to metadata are **not** automatically propogated. If you need to make changes to your metadata, you need to submit a [change request]({{< ref "/technical/saml2/forms/_index.md" >}}).
