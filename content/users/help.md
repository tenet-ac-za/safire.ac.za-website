---
date: 2026-09-03T20:30:00+02:00
menu:
  main:
...
When you first log into a service provider, we let you know what personal information will be sent to that provider. We record that you've seen the transfer notice so that your next login is quicker and we won't show you the notice again for about three months. However, you control how your personal information is handled and you can withdraw the record for any service provider at any time by clearing or deleting any cookies we've set in your browser.


We provide a way for you to clear the transfer notice records and other cookies we set during login.

> [Forget Me](https://iziko.safire.ac.za/module.php/safire/forgetme)
{.message-box}
